...
Kernel::Kernel(int argc, char** argv)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        // Todo ----
            ...
            i++;
            char *File = argv[i];
            execfile[execfileNum] = FileInfo(File, 0);
            cout << execfile[execfileNum].FileName << "\n";
        }
            ...
            execfileNum++;
        	execfile[execfileNum] = FileInfo(File, priority);
			cout << execfile[execfileNum].FileName << " with priority " << priority << "\n";
        }
        // ---------
...
// Todo ----
int Kernel::Exec(FileInfo& file)
{
    t[threadNum] = new Thread(file.FileName, threadNum, file.priority);
// ---------
