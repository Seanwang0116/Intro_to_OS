...
class Thread {
  private:
    ...
    public:
      ...
      void toReady();
      Manager(Thread * t, int priority = 0);
  ...
  public:
    ...
    // Todo ----
    void setStatus(ThreadStatus st, Thread *last = nullptr);
    int getPriority() { return this_queue->getPriority(); }
    static int compare_priority(Thread *t1, Thread *t2);
    // ---------
